        ...
        <div class="fade-in">
			...
			<div class="col-md-10 col-12 ">
				...
				<div class="col-lg-7 col-12 ml-5 mt-5">
				 <form action="" method="post" class="upload_education_level_form" id="upload_education_level_form" enctype="multipart/form-data">
             {{ csrf_field() }}
					<div class="card">
                    <div class="card-header"><strong>Upload CSV</strong> <a  class="down px-3"  href="template/education_level_template.csv">Download Template</a></div>
...
$( document ).ready(function() {
	...
	/*
	  ...
	  */
		var form = $(".upload_education_level_form");
		form.parsley().validate();
		if(form.parsley().isValid())
		{
      var formData = new FormData($('#upload_education_level_form')[0]);
        var file = $('input[type=file]')[0].files[0];
        formData.append('file', file, file.name);
        $.ajax({
            url: "{{ route('eductionlevelupload.post') }}",
