...
.invalid_password
{
  ...
  <div class="container add-grading-page">
        <div class="fade-in">
			...
			<form action='#' name="gradeform" class="save_grading_form" method="post" >
            ...
            <div class="col-md-12 adding-grade col-12 row mt-5">
				...
				<div class="col-12 mb-3">
					...
					<div class="btn-group row mx-0 ml-2">
                         <select class="form-control educationlevel_id" id="educationlevel_id" name="educationlevel_id" >
				...
				<div class="col-12 mb-6 percent">				
					...
					<tr class="tr_clone">
						...
						<td><img class="tr_clone_add" src="{{ url('/img/add.png') }}" style="width:20px"></img></td>
						<td><img class="tr_clone_remove" src="{{ url('/img/remove.png') }}" style="width:20px"></img></td>
					</tr>
					</table>
				</div><br>			
...
var ctryids = [];
        $(document).on("click", that.selector + ".multiselect option", function(e) {
            ...
            var selectionname = $(this).attr("data-id");
			if($(this).hasClass( "selected" ))
			{
				//var idx = $.inArray(ctryids, selectionname);
				var ctryIndex = ctryids.indexOf(selectionname);
				// if (idx == -1) 
				// {
				// 	ctryids.push(selectionname);
				// } else {
				// 	ctryids.splice(idx, 1);
				// }
				ctryids.splice(ctryIndex, 1);
			}
			else
			{
				// var idx = $.inArray(ctryids, selectionname);
...
$(document).ready(function() {
    var multi = new Multiselect("#country_id");
});	
