<header class="c-header c-header-light c-header-fixed">
	...
	<img src="{{ url('/svg/menu.svg') }}" width="24">
	</button>
...
<img src="{{ url('/svg/search.svg') }}">

</div>
</li>
	</ul> 
	<ul class="c-header-nav pr-5">
	...
	<div class="message">
	<div class="py-3 mfe-3 float-left">
		<div class="c-avatar"><img class="c-avatar-img" src="assets/img/avatars/6.jpg" alt="{{ Auth::user()->email }}"><span class="c-avatar-status bg-warning"></span></div>
	</div>
	...
	<div class="message">
	<div class="py-3 mfe-3 float-left">
	<div class="c-avatar"><img class="c-avatar-img" src="assets/img/avatars/5.jpg" alt=""><span class="c-avatar-status bg-danger"></span></div>
	</div>
	...
	<div class="message">
	<div class="py-3 mfe-3 float-left">
	<div class="c-avatar"><img class="c-avatar-img" src="assets/img/avatars/4.jpg" alt=""><span class="c-avatar-status bg-info"></span></div>
	</div>
