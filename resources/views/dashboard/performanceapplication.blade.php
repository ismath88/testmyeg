  ...
  <div class="container account-page">
        <div class="fade-in">
			...
			<div class="row mx-0 mb-3">
				<h5 class="pl-3 app-perform-head"> STATISTICS </h5>
			</div>
			...
			<div class="row mx-0 mb-3">
				...
				<div class="col-md-3 col-lg-3 date-box uni-no-padd">
					<div class="date-inner">
						<div class="degree-text">Applications Income</div>
						<div class="reject-number text-left">  $<span class="approve_amt_val">{{$result['approved_application_amt']}}</span></div>  
						<div class="row pt-2 mx-0 mr-3 "><div class="col dates day_btn">Day<?php //echo date('Y-m-d') ?></div><div class="col dates  px-0 week_btn">Week<?php 
			...
			<div class="row mx-0 mb-4 px-0 box-shadow-show">
				<div class="col-md-9 dash-app-county card mb-0 px-0">
					...
					<div class="d-flex mt-3 mb-3 border-top px-0">
				...
				<div class="col-md-3 card mb-0">
					<div class="row dash-app-count mr-2 box-shadow-none">
...
$( document ).ready(function() {
	...
	$('.pick_country_id').click(function(event) {
		...
		window.location.href = 'performanceapplication?country_id=' + country_id;
	});
