...
.parsley-type
{
  ...
  <div class="container grading-page">
        <div class="fade-in">
            ...
            <div class="col-lg-7 col-10 ml-5 mt-5">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
									...
									<textarea class="form-control message" rows="10" id="txtmsg" name="txtmsg" autocomplete="message" placeholder="" required></textarea>
...
$( document ).ready(function() {
	 ...
	 $(".backbtn").click(function(e)	{	
			...
			var url ="{{ url('university-pendinginvites') }}";
