...
define('REDIRECT_URI', 'http://admin.formeeexpress.com/zoom/callback.php');
...
try {
 ...
 $params = explode(',',base64_decode($_GET['state']));
    ...
    //if($db->is_table_empty()) {
        ...
        {
            header("Location: http://university.formeeexpress.com/#/universitycalendar");
        }
        if($params[1] == "Agent")
        {
            header("Location: http://agents.formeeexpress.com/#/agentcalendar");
        }
        if($params[1] == "Admin")
        {
            header("Location: http://admin.formeeexpress.com/createmeeting?msg=".$msg);            
        }
